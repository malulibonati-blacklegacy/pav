...
export default function MetaTab({ leads, costs }: Props) {
  ...
  const byCampaign = Object.entries(
    ...
    id, nome:campNameById[id]||id, leads:leadsVal,
  ...
  return (
    <>
      ...
      <div className="chart-card animate-fadeUp animate-delay-2" style={{marginBottom:24}}>
        <div className="chart-header"><div><div className="chart-title">CPL por Dia — Meta</div><div className="chart-subtitle">Custo por lead diário</div></div></div>
          ...
          <div style={{display:'flex',alignItems:'center',gap:20,flex:1}}>
            <div style={{flexShrink:0}}>
              <ResponsiveContainer width={140} height={160}>
                <PieChart>
                  <Pie data={byPlacement.slice(0,6)} cx="50%" cy="50%" innerRadius={38} outerRadius={65} dataKey="leads" paddingAngle={3}>
      ...
      {/* Top 5 Ads */}
      <div className="section-label animate-fadeUp animate-delay-3" style={{marginTop:16}}>Top Anúncios</div>
      ...
      <div className="chart-card animate-fadeUp animate-delay-4" style={{marginBottom:24}}>
        <div className="chart-header"><div><div className="chart-title">Leads & Investimento por Campanha</div><div className="chart-subtitle">Selecione uma campanha para análise detalhada do período filtrado</div></div></div>
        <CampaignChart leads={leads} costs={costs} color="#A78BFA" colorSecondary="#C4B5FD"/>
      </div>
    </>
  )
}
