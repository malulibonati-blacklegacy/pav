  ...
  return (
    <>
      ...
      <div className="chart-card animate-fadeUp animate-delay-2" style={{marginBottom:24}}>
        <div className="chart-header"><div><div className="chart-title">CPL por Dia — Google</div><div className="chart-subtitle">Custo por lead diário</div></div></div>
      ...
      <div className="table-card animate-fadeUp animate-delay-3" style={{marginBottom:24}}>
        <div className="table-header">
          <div className="table-title">Todos os Anúncios</div>
      ...
      <div className="chart-card animate-fadeUp animate-delay-4" style={{marginBottom:24}}>
        ...
        <CampaignChart leads={leads} costs={costs} color="#22D3EE" colorSecondary="#67E8F9"/>
      </div>
    </>
  )
}
